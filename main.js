...
const matrial = new THREE.MeshStandardMaterial({ color: "blue" });
const torus = new THREE.Mesh(geometry, matrial);
...
function addStars() {
  ...
  const matrial = new THREE.MeshStandardMaterial({ color: 0xffffff });
...
const moonTexture = new THREE.TextureLoader().load("moon.avif");
